...
cc.Class({
  ...
  init: function () {
    ...
    const t = cc.find('Canvas/UILayer/pen/lineLength').width
    const n = this
    const c = cc.callFunc(this.shake, this)
    t > this.star2.x + 120
      ? (n.starsNode.children[1].children[1].active = !1, n.starsNode.children[2].children[1].active = !1, setTimeout(function () {
          n.starsNode.children[0].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c)), setTimeout(function () {
            n.starsNode.children[0].children[0].getComponent(cc.ParticleSystem).resetSystem(), n.starsNode.children[1].children[1].active = !0, n.starsNode.children[1].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c))
          }, 300), setTimeout(function () {
            n.starsNode.children[1].children[0].getComponent(cc.ParticleSystem).resetSystem(), n.starsNode.children[2].children[1].active = !0, n.starsNode.children[2].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c))
          }, 600), setTimeout(function () {
            n.starsNode.children[2].children[0].getComponent(cc.ParticleSystem).resetSystem()
          }, 900)
        }, 500), this.goldReward = o.updateLevelStar('level' + a.currentLevel, 3, this.goldShow))
      : t > this.star1.x + 120
        ? (this.starsNode.children[2].children[1].active = !1, this.starsNode.children[2].children[0].active = !1, n.starsNode.children[1].children[1].active = !1, setTimeout(function () {
            n.starsNode.children[0].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c)), setTimeout(function () {
              n.starsNode.children[0].children[0].getComponent(cc.ParticleSystem).resetSystem(), n.starsNode.children[1].children[1].active = !0, n.starsNode.children[1].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c))
            }, 300), setTimeout(function () {
              n.starsNode.children[1].children[0].getComponent(cc.ParticleSystem).resetSystem()
            }, 600)
          }, 500), this.goldReward = o.updateLevelStar('level' + a.currentLevel, 2, this.goldShow))
        : (this.starsNode.children[1].children[1].active = !1, this.starsNode.children[2].children[1].active = !1, this.starsNode.children[1].children[0].active = !1, this.starsNode.children[2].children[0].active = !1, setTimeout(function () {
            n.starsNode.children[0].children[1].runAction(cc.sequence(cc.scaleTo(0.3, 1).easing(cc.easeCubicActionIn()), c)), setTimeout(function () {
  ...
  shake: function () {
    const e = cc.find('Canvas/complete/completeNode')
    this.schedule(function () {
      e.position = cc.v2(0, 0), e.position = cc.v2(5 * (Math.random(0, 1) - 0.5), 5 * (Math.random(0, 1) - 0.5))
    }, 0.05, 4)
  },
